...
"use strict";
!function (e) {
  var t = 0, n = function e(n, i) {
    var s = this, r = this, o = !1;
    ...
    var a = {
      init: function () {
        ...
        var s = this.options, o = s.elementClass, a = s.openOnInit, c = "string" == typeof n;
        ...
        var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = this.options, i = n.duration,
          s = n.panelClass, r = e.querySelector(".".concat(s)), o = c("transitionDuration");
        r.style[o] = t ? null : "".concat(i, "ms")
      }, generateIDs: function (e) {
        var n = this.options, i = n.triggerClass, s = n.panelClass, r = e.querySelector(".".concat(i)),
        ...
        var t = this.options, n = t.triggerClass, i = t.panelClass, s = e.querySelector(".".concat(n)),
          r = e.querySelector(".".concat(i));
        e.removeAttribute("id"), s.removeAttribute("id"), r.removeAttribute("id")
      }, setARIA: function (e) {
        var n = this.options, i = n.ariaEnabled, s = n.triggerClass, r = n.panelClass;
        if (i) {
          var o = e.querySelector(".".concat(s)), a = e.querySelector(".".concat(r));
        ...
        var n = t.ariaExpanded, i = t.ariaDisabled, s = this.options, r = s.ariaEnabled, o = s.triggerClass;
        if (r) {
          var a = e.querySelector(".".concat(o));
          a.setAttribute("aria-expanded", n), a.setAttribute("aria-disabled", i)
        }
      }, removeARIA: function (e) {
        var t = this.options, n = t.ariaEnabled, i = t.triggerClass, s = t.panelClass;
        if (n) {
          var r = e.querySelector(".".concat(i)), o = e.querySelector(".".concat(s));
        ...
        var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], n = this.options, i = n.panelClass,
          s = n.activeClass, r = n.collapse, o = n.beforeOpen, a = e.querySelector(".".concat(i)), c = a.scrollHeight;
        ...
        var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], n = this.options, i = n.panelClass,
          s = n.activeClass, r = n.beforeClose, o = e.querySelector(".".concat(i)), a = o.scrollHeight;
        ...
        var t = this.options, n = t.activeClass, i = t.collapse, s = e.classList.contains(n);
        ...
        if ("height" === e.propertyName) {
          var t = this.options, n = t.onOpen, i = t.onClose, s = e.currentTarget, r = parseInt(s.style.height),
    ...
    this.attachEvents = function () {
      if (!o) {
        ...
        a.handleClick = a.handleClick.bind(a), a.handleKeydown = a.handleKeydown.bind(a), a.handleTransitionEnd = a.handleTransitionEnd.bind(a), a.elements.map((function (e) {
          var i = e.querySelector(".".concat(t)), s = e.querySelector(".".concat(n));
